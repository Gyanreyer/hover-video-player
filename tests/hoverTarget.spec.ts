...
const expectComponentHasHoverTarget = async (page: Page, isMobile: boolean, componentLocator: Locator, expectedElementLocator: Locator) => {
    ...
    await hoverOver(expectedElementLocator, isMobile);
    await expect(video).toHaveJSProperty("paused", false);
    // Mousing out of the hover target should pause the video
    await hoverOut(expectedElementLocator, isMobile);
    await expect(video).toHaveJSProperty("paused", true);
}

test("hoverTarget can be updated via attribute for a component with an initial hover target set", async ({ page, isMobile }) => {
    ...
    await expectComponentHasHoverTarget(page, isMobile, componentWithInitialHoverTarget, hoverTarget1);
    ...
    await expectComponentHasHoverTarget(page, isMobile, componentWithInitialHoverTarget, hoverTarget2);
    ...
    await expectComponentHasHoverTarget(page, isMobile, componentWithInitialHoverTarget, componentWithInitialHoverTarget);
...
test("hoverTarget can be updated for a component without an initial hover target set", async ({ page, isMobile }) => {
    await page.goto("/tests/hoverTarget.html");
    ...
    await expectComponentHasHoverTarget(page, isMobile, componentWithNoInitialHoverTarget, componentWithNoInitialHoverTarget);
    ...
    await expectComponentHasHoverTarget(page, isMobile, componentWithNoInitialHoverTarget, hoverTarget2);
    ...
    await expectComponentHasHoverTarget(page, isMobile, componentWithNoInitialHoverTarget, hoverTarget1);
    // The hover-target attribute should be cleared
...
test("Multiple hoverTargets can be set at the same time for a single component", async ({ page, isMobile }) => {
    await page.goto("/tests/hoverTarget.html");
    ...
    await expectComponentHasHoverTarget(page, isMobile, componentWithMultipleHoverTargets, hoverTarget1);
    await expectComponentHasHoverTarget(page, isMobile, componentWithMultipleHoverTargets, hoverTarget2);
    ...
    await expectComponentHasHoverTarget(page, isMobile, componentWithMultipleHoverTargets, componentWithMultipleHoverTargets);
